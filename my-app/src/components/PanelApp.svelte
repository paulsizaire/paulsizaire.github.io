<script>
    ...
    //load emissions data
    let emissionsFile = "https://raw.githubusercontent.com/paulsizaire/paulsizaire.github.io/socioeconomic-panel/ACS/emissions.csv";
    
    //load employment data
    let employmentFile = "https://raw.githubusercontent.com/paulsizaire/paulsizaire.github.io/main/ACS/employment.csv"

    //load employment data
    let ecfFile = "https://raw.githubusercontent.com/paulsizaire/paulsizaire.github.io/main/ACS/ecf.csv"
    ...
    onMount(async function() {
        ...
        employment_data = await 
        
        d3.csv(employmentFile,
        function(d) {
            return {
                industry: d.FIPS,
...
<Box>
    ...
    <section class="graph">
        <EmploymentGraph  bind:employment_data={employment_data}/>
    </section>

    <h2> ECF Comparison </h2>
    <section class="bar">
        <ECF_BarGraph  bind:ecf_data={ecf_data}/>
    </section>
